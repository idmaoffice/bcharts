   ...
   <div class="d-wrapper">
         ...
         <ul class="sidebar__list">
            <li>
               <a href="#">
                  <!-- <svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M20.9497 22.3075L13.7913 15.1491C12.7924 14.1503 12.2306 12.8185 12.2306 11.4035C12.2306 9.98844 12.7716 8.65665 13.7705 7.65781C14.4364 6.99191 15.2687 6.5133 16.2052 6.2844L16.8503 6.11792C16.8503 4.36995 16.8503 1.70636 16.8503 1.01966V0.020813L15.8514 0.166478C13.4375 0.499426 11.2318 1.60232 9.48378 3.35029C7.34042 5.49364 6.1543 8.36532 6.1543 11.4035C6.1543 14.4416 7.34042 17.2925 9.48378 19.4566L16.6422 26.615C17.2248 27.1977 17.9739 27.5098 18.7855 27.5098C19.5971 27.5098 20.367 27.1977 20.9289 26.615C22.1358 25.4289 22.1358 23.4936 20.9497 22.3075Z" fill="#FACC15"/>
                    <path d="M32.7485 10.5087L25.5901 3.35031C24.2167 1.9769 22.4688 0.957248 20.5751 0.437017L19.4722 0.124878V6.45089L19.9508 6.7006C20.4503 6.95031 20.8873 7.28326 21.2826 7.67864L28.441 14.837C29.0237 15.4197 29.7728 15.7318 30.5844 15.7318C31.3959 15.7318 32.1659 15.4197 32.7277 14.837C33.9347 13.6301 33.9346 11.6948 32.7485 10.5087Z" fill="#FACC15"/>
                    <path d="M15.0607 28.3422L7.90231 21.1838C7.31965 20.6012 6.57052 20.289 5.75896 20.289C4.9474 20.289 4.17746 20.6012 3.61561 21.1838C2.42948 22.37 2.42948 24.3052 3.61561 25.4913L10.774 32.6497C12.1682 34.0439 13.8954 35.0428 15.789 35.563L16.8919 35.8752V29.5492L16.4133 29.2994C15.8931 29.0497 15.4353 28.7168 15.0607 28.3422Z" fill="#FACC15"/>
                    <path d="M19.6803 9.38497C19.0977 8.80231 18.3485 8.49017 17.537 8.49017C16.7254 8.49017 15.9555 8.80231 15.3936 9.38497C14.2075 10.5711 14.2075 12.5064 15.3936 13.6925L22.552 20.8509C23.5509 21.8497 24.1127 23.1815 24.1127 24.5965C24.1127 26.0116 23.5717 27.3434 22.552 28.3422C21.8861 29.0081 21.0537 29.4867 20.1381 29.7156L19.4722 29.8821V36L20.4711 35.8543C22.9058 35.5006 25.1115 34.3977 26.8595 32.6497C29.0029 30.5064 30.189 27.6347 30.189 24.5965C30.189 21.5584 29.0029 18.7075 26.8595 16.5434L19.6803 9.38497Z" fill="#FACC15"/>
                    </svg> -->
            ...
            <li class="not-active">
               <a href="#">
                  ...
                  <span>Pool Explorer (soon)</span></a>
            </li>
            <li>
      ...
      <!-- <section class="advertising">
         <div class="advertising__box">
            <div class="item__advertising__img">
      ...
      <section class="strip__info">
         ...
         <!-- <div class="moving-content">
            <div class="item"><span class="position">#1</span><span class="name">BNB</span></div>
            <div class="item"><span class="position">#2</span><span class="name">TOOLS</span></div>
            <div class="item"><span class="position">#3</span><span class="name">BSCX</span></div>
            <div class="item"><span class="position">#4</span><span class="name">CAKE</span></div>
            <div class="item"><span class="position">#5</span><span class="name">XVS</span></div> 
         </div> -->
      ...
      <section class="table__widget">
         ...
         <!-- Код парсера вставлять сюда -->
         <?php
//         $handle = curl_init();
//     curl_setopt($handle, CURLOPT_URL, "https://bscscan.com/txs?a=0x21dd71ab78ede3033c976948f769d506e4f489ee");
