   ...
   <body class="d-body">
      <div class="d-wrapper">
         ...
         <section class="s-widget__schedule">
            ...
            <div id="tradingview_02df6"></div>
            <div class="tradingview-widget-copyright"><a href="https://ru.tradingview.com/symbols/BUSDUSDT/?exchange=BINANCE" rel="noopener" target="_blank"><span class="blue-text">График BUSDUSDT</span></a> от TradingView</div>
            <script type="text/javascript" src="https://s3.tradingview.com/tv.js"></script>
            <script type="text/javascript">
            new TradingView.widget(
            {
            ...
            "hide_side_toolbar": false,
            "allow_symbol_change": true,
            "container_id": "tradingview_02df6"
            }
            );
            </script>
            </div>
