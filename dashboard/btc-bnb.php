...
<html lang="en">
   ...
   <body class="d-body">
      <div class="d-wrapper">
        ...
        <div id="tradingview_6c7df"></div>
        <div class="tradingview-widget-copyright"><a href="https://ru.tradingview.com/symbols/BTCBNB/?exchange=POLONIEX" rel="noopener" target="_blank"><span class="blue-text">График BTCBNB</span></a> от TradingView</div>
        <script type="text/javascript" src="https://s3.tradingview.com/tv.js"></script>
        <script type="text/javascript">
        new TradingView.widget(
        {
        ...
        "hide_side_toolbar": false,
        "allow_symbol_change": true,
        "container_id": "tradingview_6c7df"
        }
        );
        </script>
        </div>
