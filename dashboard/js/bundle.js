! function(e, t) { "object" == typeof exports && "undefined" != typeof module ? t(exports) : "function" == typeof define && define.amd ? define(["exports"], t) : t(e.Datafeeds = {}) }(this, function(e) {
    ...
    function n(e) {
        var t;
        r && (t = new Date, console.log(t.toLocaleTimeString() + "." + t.getMilliseconds() + "> " + e))
    }
    ...
    function o(e, t) { this._subscribers = {}, this._requestsPending = 0, this._historyProvider = e, setInterval(this._updateData.bind(this), t) }
    var u = (l.prototype.subscribeQuotes = function(e, t, r, s) { this._subscribers[s] = { symbols: e, fastSymbols: t, listener: r }, n("QuotesPulseProvider: subscribed quotes with #" + s) }, l.prototype.unsubscribeQuotes = function(e) { delete this._subscribers[e], n("QuotesPulseProvider: unsubscribed quotes with #" + e) }, l.prototype._updateQuotes = function(s) {
        var o = this;
        if (!(0 < this._requestsPending)) {
            var e = this;
            for (var t in this._subscribers) ! function(t) {
                e._requestsPending++;
                var r = e._subscribers[t];
                e._quotesProvider.getQuotes(1 === s ? r.fastSymbols : r.symbols).then(function(e) { o._requestsPending--, o._subscribers.hasOwnProperty(t) && (r.listener(e), n("QuotesPulseProvider: data for #" + t + " (" + s + ") updated successfully, pending=" + o._requestsPending)) }).catch(function(e) { o._requestsPending--, n("QuotesPulseProvider: data for #" + t + " (" + s + ") updated with error=" + c(e) + ", pending=" + o._requestsPending) })
            }(t)
        }
    }, l);

    function l(e) { this._subscribers = {}, this._requestsPending = 0, this._quotesProvider = e, setInterval(this._updateQuotes.bind(this, 1), 1e4), setInterval(this._updateQuotes.bind(this, 0), 6e4) }

    function d(e, t, r, s) { var o = e[t]; return !Array.isArray(o) || s && !Array.isArray(o[0]) ? o : o[r] }
    var h = (f.prototype.resolveSymbol = function(t) { var r = this; return this._readyPromise.then(function() { var e = r._symbolsInfo[t]; return void 0 === e ? Promise.reject("invalid symbol") : Promise.resolve(e) }) }, f.prototype.searchSymbols = function(a, u, c, s) {
        var l = this;
        return this._readyPromise.then(function() {
            var i = [],
                n = 0 === a.length;
            a = a.toUpperCase();
            for (var e = 0, t = l._symbolsList; e < t.length; e++) ! function(e) {
                var t, r, s, o = l._symbolsInfo[e];
                void 0 !== o && (0 < c.length && o.type !== c || u && 0 < u.length && o.exchange !== u || (r = o.name.toUpperCase().indexOf(a), s = o.description.toUpperCase().indexOf(a), (n || 0 <= r || 0 <= s) && (i.some(function(e) { return e.symbolInfo === o }) || (t = 0 <= r ? r : 8e3 + s, i.push({ symbolInfo: o, weight: t })))))
            }(t[e]);
            var r = i.sort(function(e, t) { return e.weight - t.weight }).slice(0, s).map(function(e) { var t = e.symbolInfo; return { symbol: t.name, full_name: t.full_name, description: t.description, exchange: t.exchange, params: [], type: t.type, ticker: t.name } });
    ...
    function f(e, t, r) { this._exchangesList = ["NYSE", "FOREX", "AMEX"], this._symbolsInfo = {}, this._symbolsList = [], this._datafeedUrl = e, this._datafeedSupportedResolutions = t, this._requester = r, this._readyPromise = this._init(), this._readyPromise.catch(function(e) { console.error("SymbolsStorage: Cannot init, error=" + e.toString()) }) }

    function p(e, t) { return void 0 !== e ? e : t }

    function _(e, t, r) { var s = e[t]; return Array.isArray(s) ? s[r] : s }
    var m = (b.prototype.onReady = function(e) {
        var t = this;
        this._configurationReadyPromise.then(function() { e(t._configuration) })
    }, b.prototype.getQuotes = function(e, t, r) { this._quotesProvider.getQuotes(e).then(t).catch(r) }, b.prototype.subscribeQuotes = function(e, t, r, s) { this._quotesPulseProvider.subscribeQuotes(e, t, r, s) }, b.prototype.unsubscribeQuotes = function(e) { this._quotesPulseProvider.unsubscribeQuotes(e) }, b.prototype.calculateHistoryDepth = function(e, t, r) {}, b.prototype.getMarks = function(e, t, r, s, o) {
        var i;
        this._configuration.supports_marks && (i = { symbol: e.ticker || "", from: t, to: r, resolution: o }, this._send("marks", i).then(function(e) {
            if (!Array.isArray(e)) {
                for (var t = [], r = 0; r < e.id.length; ++r) t.push({ id: _(e, "id", r), time: _(e, "time", r), color: _(e, "color", r), text: _(e, "text", r), label: _(e, "label", r), labelFontColor: _(e, "labelFontColor", r), minSize: _(e, "minSize", r) });
                e = t
            }
            s(e)
        ...
        var i;
        this._configuration.supports_timescale_marks && (i = { symbol: e.ticker || "", from: t, to: r, resolution: o }, this._send("timescale_marks", i).then(function(e) {
            if (!Array.isArray(e)) {
                for (var t = [], r = 0; r < e.id.length; ++r) t.push({ id: _(e, "id", r), time: _(e, "time", r), color: _(e, "color", r), label: _(e, "label", r), tooltip: _(e, "tooltip", r) });
                e = t
            }
            s(e)
        ...
        if (this._configuration.supports_search) {
            ...
            this._send("search", o).then(function(e) { return void 0 !== e.s ? (n("UdfCompatibleDatafeed: search symbols error=" + e.errmsg), void s([])) : void s(e) }).catch(function(e) { n("UdfCompatibleDatafeed: Search symbols for '" + t + "' failed. Error=" + c(e)), s([]) })
        } else {
    ...
    function g(e, t) { this._datafeedUrl = e, this._requester = t }
    var P = (q.prototype.sendRequest = function(e, t, r) {
        var s;
        void 0 !== r && (0 !== (s = Object.keys(r)).length && (t += "?"), t += s.map(function(e) { return encodeURIComponent(e) + "=" + encodeURIComponent(r[e].toString()) }).join("&")), n("New request: " + t);
    ...
    function q(e) { e && (this._headers = e) }
    var w, D, S, x = (t(D = k, S = w = m), D.prototype = null === S ? Object.create(S) : (U.prototype = S.prototype, new U), k);

    function U() { this.constructor = D }
    ...
    e.UDFCompatibleDatafeed = x, Object.defineProperty(e, "__esModule", { value: !0 })
});